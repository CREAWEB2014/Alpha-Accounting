...
<ul class="nav social-icons clearfix">
	...
	<?php if ( '' != $social_options['google_plus'] ) { ?>
		<li><a class="fademe" href="<?php echo esc_url( $social_options['google_plus'] ); ?>" title="<?php esc_attr_e( 'Google+', 'standard'); ?>" target="_blank"><img src="<?php echo esc_url( get_template_directory_uri() . '/images/social/big/google_plus.png' ); ?>" alt="<?php esc_attr_e( 'Google+', 'standard'); ?>" /></a></li>
	<?php } // end if ?>
	...
	<?php if ( '' != $social_options['vimeo'] ) { ?>
		<li><a class="fademe" href="<?php echo esc_url( $social_options['vimeo'] ); ?>" title="<?php esc_attr_e( 'Vimeo', 'standard'); ?>" target="_blank"><img src="<?php echo esc_url( get_template_directory_uri() . '/images/social/big/vimeo.png' ); ?>" alt="<?php esc_attr_e( 'Vimeo', 'standard'); ?>" /></a></li>
	<?php } // end if ?>
